        ...
        {user && (
          <div className="mt-5 grid sm:grid-cols-3 gap-4">
            ...
            <div className="card p-4">
              ...
              <div className="text-sm">Выберите товар который есть в наличии, далее укажите свой ТГ логин чтобы мы могли с вами связаться, затем в чат KICK надо будет вставить команду которая будет показана.</div>
            </div>
          </div>
        )}
